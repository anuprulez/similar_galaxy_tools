$(document).ready(function() {
    var similarityData = null,
        ...
        pathOnline = "https://raw.githubusercontent.com/anuprulez/similar_galaxy_tools/doc2vec_2sources/viz/data/similarity_matrix.json",
        path = pathOnline;
    if ( path === "" ) {
    ...
    var showWeights = function( weights, headerText ) {
        ...
        template += "<p>Score = weight1 * similarity_input_output + weight2 * similarity_name_desc_edam </p>";
        template += "</div>";
        return template;
    };
